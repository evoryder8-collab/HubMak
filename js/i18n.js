...
(function () {
  ...
  var copy = {
    en: {
      ...
      proof_one: 'Paris · International Division Overall Winner', proof_two: 'Laval · Championship Winner', proof_three: 'Markham · MakCare Health and Wellness',
      ...
      craft_p3: 'The same focus shapes his competition work. In 2026, Hubert won in Laval and then took the International Division overall title in Paris. Those results reflect years of practice, preparation, and clear decisions under pressure.',
      ...
      honors_chapter: 'Awards', honors_title: 'Two Events. A Standout Season.', honors_lede: 'A championship win in Laval and the International Division overall title in Paris, both in 2026.',
      honors_scene_caption: 'Paris, 2026', honors_scene_note: 'The result, shared with Team Canada.',
      laval_rank: 'Champion', laval_name: 'Canadian and International Championship', laval_note: 'The season began with a championship win in Laval at the Massage Therapy Summit.',
    ...
    fr: {
      ...
      proof_one: 'Paris · Grand gagnant de la division internationale', proof_two: 'Laval · Champion', proof_three: 'Markham · MakCare Santé et Bien-être',
      ...
      craft_p3: "La même concentration guide son travail en compétition. En 2026, Hubert a gagné à Laval, puis a remporté le titre général de la division internationale à Paris. Ces résultats viennent de plusieurs années de pratique, de préparation et de décisions précises sous pression.",
      ...
      honors_chapter: 'Prix', honors_title: 'Deux événements. Une saison marquante.', honors_lede: 'Une victoire à Laval et le titre général de la division internationale à Paris, tous deux en 2026.',
      honors_scene_caption: 'Paris, 2026', honors_scene_note: "Le résultat, partagé avec l'équipe canadienne.",
      laval_rank: 'Champion', laval_name: 'Championnat canadien et international', laval_note: 'La saison a commencé par une victoire au Massage Therapy Summit de Laval.',
    ...
    yue: {
      ...
      proof_one: '巴黎 · 國際組總冠軍', proof_two: '拉瓦爾 · 錦標賽冠軍', proof_three: '萬錦市 · MakCare 健康及保健中心',
      ...
      craft_p3: '同一份專注亦帶到比賽場上。2026 年，Hubert 先在拉瓦爾奪冠，再於巴黎取得國際組總冠軍。成績來自多年練習、充分準備，同壓力下的清晰判斷。',
      craft_p4: '他繼續治療、學習同改進技術。目標一直簡單：提供專業、細心而真正有用的照顧。',
      honors_chapter: '獎項', honors_title: '兩場比賽。出色的一季。', honors_lede: '2026 年於拉瓦爾奪冠，並在巴黎贏得國際組總冠軍。',
      honors_scene_caption: '巴黎，2026', honors_scene_note: '同加拿大隊一齊分享成果。',
      laval_rank: '冠軍', laval_name: '加拿大及國際錦標賽', laval_note: '賽季由拉瓦爾 Massage Therapy Summit 的冠軍開始。',
      ...
      gallery_chapter: '治療現場', gallery_1: '專注於治療床。', gallery_2: '比賽中的泰式手法。', gallery_3: '受控的力量同幅度。', gallery_4: '承托頸部同肩膊。', gallery_5: '細心處理肩膊。', gallery_6: '拔罐配合輔助伸展。', gallery_7: '運用平衡同身體重量。', gallery_8: '透過動作回復活動幅度。', gallery_9: '全心專注於治療。', gallery_10: '配合客人的高度工作。', gallery_hint: '繼續向下捲動',
      creed_aria: '理念', creed_quote: '技術重要。連結令治療真正發揮作用。',
      contact_chapter: '聯絡', contact_title: '傾一傾', contact_lede: '預約、講座、媒體或有關 Hubert 工作的查詢，歡迎聯絡。',
    ...
    zh: {
      ...
      proof_one: '巴黎 · 国际组总冠军', proof_two: '拉瓦尔 · 锦标赛冠军', proof_three: '万锦市 · MakCare 健康与保健中心',
      ...
      craft_p3: '同样的专注也贯穿他的比赛表现。2026 年，Hubert 先在拉瓦尔夺冠，随后在巴黎赢得国际组总冠军。这些成绩来自多年的练习、充分的准备，以及压力下清晰的判断。',
      craft_p4: '他继续治疗、学习并改进技术。目标始终简单：提供专业、细致且真正有用的照护。',
      honors_chapter: '奖项', honors_title: '两场比赛。出色的一季。', honors_lede: '2026 年在拉瓦尔夺冠，并在巴黎赢得国际组总冠军。',
      honors_scene_caption: '巴黎，2026', honors_scene_note: '与加拿大队共同分享成果。',
      laval_rank: '冠军', laval_name: '加拿大及国际锦标赛', laval_note: '赛季从拉瓦尔 Massage Therapy Summit 的冠军开始。',
      ...
      gallery_chapter: '治疗现场', gallery_1: '专注于治疗台。', gallery_2: '比赛中的泰式手法。', gallery_3: '受控的力量与幅度。', gallery_4: '支撑颈部和肩部。', gallery_5: '细致的肩部治疗。', gallery_6: '拔罐配合辅助拉伸。', gallery_7: '运用平衡和身体重量。', gallery_8: '通过动作恢复活动幅度。', gallery_9: '全心专注于治疗。', gallery_10: '配合客户的高度工作。', gallery_hint: '继续向下滚动',
      creed_aria: '理念', creed_quote: '技术很重要。连接让治疗真正有效。',
      contact_chapter: '联系', contact_title: '聊一聊', contact_lede: '预约、讲座、媒体或有关 Hubert 工作的问题，欢迎联系。',
    ...
    ja: {
      ...
      proof_one: 'パリ · 国際部門総合優勝', proof_two: 'ラヴァル · 選手権優勝', proof_three: 'マーカム · MakCare Health and Wellness',
      ...
      craft_p3: '同じ集中力が競技でも生かされています。2026年、Hubert はラヴァルで優勝し、その後パリで国際部門総合優勝を果たしました。結果を支えたのは、長年の練習、準備、そしてプレッシャーの中での明確な判断です。',
      craft_p4: '現在も施術、学習、技術の改善を続けています。目標は変わりません。高い技術と細やかな配慮を備えた、役に立つケアを届けることです。',
      honors_chapter: '受賞歴', honors_title: '二つの大会。際立った一年。', honors_lede: '2026年、ラヴァルでの優勝とパリでの国際部門総合優勝。',
      honors_scene_caption: 'パリ、2026年', honors_scene_note: 'チームカナダと分かち合った結果。',
      laval_rank: '優勝', laval_name: 'カナダ・国際選手権', laval_note: 'シーズンはラヴァルの Massage Therapy Summit での優勝から始まりました。',
      ...
      gallery_chapter: '施術の現場', gallery_1: '施術台に集中。', gallery_2: '競技でのタイ式テクニック。', gallery_3: '制御された力と可動域。', gallery_4: '首と肩を支える。', gallery_5: '丁寧な肩への施術。', gallery_6: 'カッピングと補助ストレッチ。', gallery_7: 'バランスと体重を使う。', gallery_8: '動きによって可動域を戻す。', gallery_9: '施術台での完全な集中。', gallery_10: 'クライアントと同じ高さで。', gallery_hint: 'スクロールを続ける',
      creed_aria: '理念', creed_quote: '技術は大切です。つながりが技術を生かします。',
      contact_chapter: 'お問い合わせ', contact_title: 'お話ししましょう', contact_lede: '予約、セミナー、メディア、Hubert の仕事についてのご質問はこちらから。',
    ...
    de: {
      ...
      proof_one: 'Paris · Gesamtsieger der internationalen Division', proof_two: 'Laval · Meisterschaftssieger', proof_three: 'Markham · MakCare Health and Wellness',
      ...
      craft_p3: 'Die gleiche Konzentration prägt seine Arbeit im Wettbewerb. 2026 gewann Hubert in Laval und anschließend den Gesamttitel der internationalen Division in Paris. Diese Ergebnisse beruhen auf jahrelanger Übung, Vorbereitung und klaren Entscheidungen unter Druck.',
      ...
      honors_chapter: 'Auszeichnungen', honors_title: 'Zwei Wettbewerbe. Eine starke Saison.', honors_lede: 'Ein Meisterschaftssieg in Laval und der Gesamttitel der internationalen Division in Paris, beide im Jahr 2026.',
      honors_scene_caption: 'Paris, 2026', honors_scene_note: 'Das Ergebnis, gemeinsam mit Team Kanada.',
      laval_rank: 'Champion', laval_name: 'Kanadische und internationale Meisterschaft', laval_note: 'Die Saison begann mit einem Meisterschaftssieg beim Massage Therapy Summit in Laval.',
    ...
    es: {
      ...
      proof_one: 'París · Ganador absoluto de la división internacional', proof_two: 'Laval · Campeón', proof_three: 'Markham · MakCare Salud y Bienestar',
      ...
      craft_p3: 'La misma concentración guía su trabajo en competición. En 2026, Hubert ganó en Laval y después obtuvo el título absoluto de la división internacional en París. Los resultados reflejan años de práctica, preparación y decisiones claras bajo presión.',
      ...
      honors_chapter: 'Premios', honors_title: 'Dos eventos. Una temporada excepcional.', honors_lede: 'Una victoria en Laval y el título absoluto de la división internacional en París, ambos en 2026.',
      honors_scene_caption: 'París, 2026', honors_scene_note: 'El resultado, compartido con el equipo de Canadá.',
      laval_rank: 'Campeón', laval_name: 'Campeonato canadiense e internacional', laval_note: 'La temporada comenzó con una victoria en el Massage Therapy Summit de Laval.',
    ...
    pt: {
      ...
      proof_one: 'Paris · Vencedor geral da divisão internacional', proof_two: 'Laval · Campeão', proof_three: 'Markham · MakCare Saúde e Bem-estar',
      ...
      craft_p3: 'A mesma concentração orienta o seu trabalho em competição. Em 2026, Hubert venceu em Laval e depois conquistou o título geral da divisão internacional em Paris. Os resultados refletem anos de prática, preparação e decisões claras sob pressão.',
      ...
      honors_chapter: 'Prémios', honors_title: 'Dois eventos. Uma época marcante.', honors_lede: 'Uma vitória em Laval e o título geral da divisão internacional em Paris, ambos em 2026.',
      honors_scene_caption: 'Paris, 2026', honors_scene_note: 'O resultado, partilhado com a equipa do Canadá.',
      laval_rank: 'Campeão', laval_name: 'Campeonato canadiano e internacional', laval_note: 'A época começou com uma vitória no Massage Therapy Summit em Laval.',
    ...
    ru: {
      ...
      proof_one: 'Париж · Абсолютный победитель международного дивизиона', proof_two: 'Лаваль · Победитель чемпионата', proof_three: 'Маркем · Центр MakCare',
      ...
      craft_p3: 'Та же сосредоточенность определяет его работу на соревнованиях. В 2026 году Хьюберт победил в Лавале, а затем стал абсолютным победителем международного дивизиона в Париже. Эти результаты отражают годы практики, подготовку и ясные решения под давлением.',
      ...
      honors_chapter: 'Награды', honors_title: 'Два турнира. Выдающийся сезон.', honors_lede: 'Победа в Лавале и абсолютный титул международного дивизиона в Париже, оба в 2026 году.',
      honors_scene_caption: 'Париж, 2026', honors_scene_note: 'Результат, разделенный с командой Канады.',
      laval_rank: 'Чемпион', laval_name: 'Канадский и международный чемпионат', laval_note: 'Сезон начался с победы на Massage Therapy Summit в Лавале.',
      ...
      gallery_chapter: 'В практике', gallery_1: 'Полная концентрация у стола.', gallery_2: 'Тайская техника на соревновании.', gallery_3: 'Контролируемая сила и амплитуда.', gallery_4: 'Поддержка шеи и плеч.', gallery_5: 'Точная работа с плечами.', gallery_6: 'Банки и пассивная растяжка.', gallery_7: 'Баланс и вес тела в работе.', gallery_8: 'Возвращение амплитуды через движение.', gallery_9: 'Все внимание на работе.', gallery_10: 'Работа на уровне клиента.', gallery_hint: 'Продолжайте листать',
      creed_aria: 'Философия', creed_quote: 'Техника важна. Контакт делает ее эффективной.',
      contact_chapter: 'Контакты', contact_title: 'Давайте поговорим', contact_lede: 'По вопросам записи, семинаров, прессы или работы Хьюберта.',
